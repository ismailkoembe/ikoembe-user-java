package com.ikoembe.user.controller;

import com.ikoembe.user.models.Gender;
import com.ikoembe.user.payload.request.GuardianInfo;
import com.ikoembe.user.payload.response.MessageResponse;
import com.ikoembe.user.payload.response.RegistrationDetails;
import com.ikoembe.user.payload.response.UserResponse;
import com.ikoembe.user.repository.RoleRepository;
import com.ikoembe.user.repository.UserRepository;
import com.ikoembe.user.security.jwt.JwtUtils;
import com.ikoembe.user.models.ERole;
import com.ikoembe.user.models.Role;
import com.ikoembe.user.models.User;
import com.ikoembe.user.security.services.UserDetailsImpl;
import com.ikoembe.user.service.UserImplementation;
import com.ikoembe.user.util.ErrorResponse;
